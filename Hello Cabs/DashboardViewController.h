...
@interface DashboardViewController : UIViewController<CLLocationManagerDelegate,UIGestureRecognizerDelegate,GMSAutocompleteViewControllerDelegate,SampleProtocolDelegate>
{
...
@property (weak, nonatomic) IBOutlet UILabel *lblRideNow;
@property (weak, nonatomic) IBOutlet UILabel *lblRideLater;
- (IBAction)clickFavList:(id)sender;
- (IBAction)clickCall:(id)sender;
@property (weak, nonatomic) IBOutlet UIImageView *imgCorner;
